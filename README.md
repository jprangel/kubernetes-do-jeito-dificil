...
* _PENDENTE_ [Provisionando a CA e Gerando Certificados TLS](docs/04-autoridade-certificadora.md)
...
* _PENDENTE_ [Subindo os Nós Worker do Kubernetes](docs/09-subindo-workers-kubernetes.md)
